...
classes=[]
with open("/tmp/flowers/labels.txt", "r") as fp:
    data = fp.readlines()
    for l in data:
...
with tf.Graph().as_default():
    ...
    file_path = '/home/michael/Pictures/carnation.jpg'
    ...
    with slim.arg_scope(inception.inception_v3_arg_scope()):
        logits, _ = inception.inception_v3(processed_images, num_classes=5, is_training=False)
